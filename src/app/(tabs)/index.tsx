...
import { LevelUpModal } from "../../components/game/Modals";
...
const MOCK_DECK: Card[] = [
  {
    ...
    answer: '"1,23,4"',
    explanation: "Di JS, operator + mengkonversi array jadi string dulu.",
    roast: "Kamu pikir ini Python bisa merge list?",
  },
  {
    id: "2",
    type: "snippet",
    ...
    answer: "False",
    explanation: "Floating point math tidak akurat.",
    roast: "Matematika komputer itu beda.",
  },
];
