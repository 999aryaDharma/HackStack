// src/components/game/Modals.tsx
...
export function RoastModal({ visible, message, onClose }: RoastModalProps) {
  return (
    <Modal
      animationType="slide"
      transparent={true}
    ...
    >
      <View style={styles.overlay}>
        <View style={[styles.modal, { borderColor: COLORS.accent.red }]}>
          <Text style={[styles.header, { color: COLORS.accent.red }]}>
            WRONG!
          </Text>
          <Text style={styles.message}>{message}</Text>
          <Pressable
            style={[styles.button, { backgroundColor: COLORS.accent.red }]}
            onPress={onClose}
          >
